...
public final class UserStore implements Closeable {
    ...
    public UserStore() throws StoreException , IOException {
        try {
    ...
    public void addUser(User userToAdd) throws StoreException {
        try {
            PreparedStatement preparedStatement = connection.prepareStatement("insert into user (firstname, lastname) values (?, ?)");
